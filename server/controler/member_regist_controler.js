...
class MemberRegistControler extends base_controler.BaseControler {
    // コンストラクター
    constructor() {
        super();
    }
    ...
    memberRegistSubmit(req, res) {
        ...
        // メンバー登録
        memberModel.registMember(req.query).then(function (in_member_id) {
...
exports.MemberRegistControler = MemberRegistControler;
//# sourceMappingURL=member_regist_controler.js.map